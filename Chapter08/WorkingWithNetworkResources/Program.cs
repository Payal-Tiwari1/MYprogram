...
using System.Net.NetworkInformation;  //ping,pingReply,IPAddress


//Break Down of Web Address
WriteLine("----------------------Break Down Of Address-------------------------");
...
//IP address for the entered website
